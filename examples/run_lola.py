...
logger = MLflowLogger(
    enabled=True,
    experiment_name="orion-lola",
)
set_logger(logger)
logger.start_run(run_name="lola_mnist", tags={"model": "LoLA", "dataset": "MNIST"})
...
train_on_mnist(
    ...
    epochs=5,
    device=device,
    save_path="../data/models/lola_mnist.pth",
)
...
logger.log_artifact("../configs/lola.yml", "config")
